    ...
    with gr.Tab("Inference"):
        ...
        with gr.Row():
            ...
            with gr.Column():
                ...
                with gr.Row():
                    f0method0 = gr.Radio(
                    label="Optional: Change the Pitch Extraction Algorithm. Use PM for fast results or Harvest for better low range (but it's extremely slow) or Crepe for the best of both worlds, rmvpe is best one.",
